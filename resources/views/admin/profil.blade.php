            ...
            <div class="card-body">
                <form action="{{Route('profil.update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group align-left">
                        ...
                        <input type="text" class="form-control" id="no_wa" value="{{$profil->no_wa}}" name="no_wa">
                    </div>
                    <div class="form-group align-left">
                        <label class="" for="facebook">Facebook</label>
                        <input type="text" class="form-control" id="facebook" value="{{$profil->facebook}}" name="facebook">
                    </div>
                    <div class="form-group align-left">
                        <label class="" for="instagram">Instagram</label>
                        <input type="text" class="form-control" id="instagram" value="{{$profil->instagram}}" name="instagram">
                    </div>
